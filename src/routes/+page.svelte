<script lang="ts">
	...
	// Animated typing effect for the hero terminal
	...
	const lines = [
		...
		'',
		'## Active Tools',
		'- Scanner: Protecting 847 repos',
		'- Mind: 12,400 memories stored',
		'- Spawner: 3 agents ready',
		'',
		'## Latest Alert',
		'SQL injection blocked in user-api.ts',
		'',
		'Ready to vibe.'
	];
...
<main>
	...
	<section class="hero">
		...
		<div class="hero-terminal">
			<div class="terminal-header">
				...
				<span class="terminal-title">vibeship</span>
			</div>
			<div class="terminal-body">
				{#each terminalLines as line}
					...
					{:else if line.startsWith('Ecosystem')}
						<div class="line status">{line}</div>
					{:else if line.startsWith('SQL')}
						<div class="line alert">{line}</div>
					{:else if line.startsWith('Ready')}
						<div class="line ready">{line}</div>
					{:else}
	...
	<section class="ecosystem-flow">
		<h2>One Ecosystem. Four Powers.</h2>
		<p class="section-subtitle">Tools that work together to make vibe coding actually safe.</p>
		...
		<div class="flow-diagram">
			...
			<div class="flow-node scanner">
				...
				<span>Scanner</span>
				<div class="node-desc">catches vulns</div>
			</div>
			...
			<div class="flow-node mind">
				...
				<span>Mind</span>
				<div class="node-desc">remembers</div>
			</div>
			...
			<div class="flow-node spawner">
				...
				<span>Spawner</span>
				<div class="node-desc">parallelizes</div>
			</div>
		</div>
	</section>
...
<style>
	...
	.hero-terminal {
		...
		text-align: left;
		border: 1px solid var(--green-dim);
		box-shadow: 0 0 30px rgba(0, 196, 154, 0.15), 0 10px 40px rgba(0, 0, 0, 0.3);
	}
	...
	.ecosystem-flow h2, .products h2, .why h2, .final-cta h2 {
		font-family: 'Instrument Serif', Georgia, serif;
		font-size: 2.5rem;
		font-weight: 400;
		text-align: center;
	...
	.flow-node.scanner .node-icon,
	.flow-node.mind .node-icon,
	.flow-node.spawner .node-icon {
		color: var(--green-dim);
	}
