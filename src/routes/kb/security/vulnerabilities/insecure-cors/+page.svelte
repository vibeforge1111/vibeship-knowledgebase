...
<main class="article-container">
	...
	<article class="security-article">
		...
		<section class="content-section">
			...
			<p>
				According to our <a href="/kb/ai-patterns/claude-code/">Claude Code security patterns</a> analysis, 38% of AI-generated projects have insecure CORS defaults. The AI optimizes for "working code" without considering that wildcard CORS + authenticated APIs = anyone can steal your users' data.
			</p>
			<p>
